      ...
      <div class="row justify-content-md-center">
        <div class="col-md-9 ">
            <div class="card px-5 py-3 mt-5 shadow">
               <h1 class="text-danger text-center mt-3 mb-4">Form With PDF Preview</h1>
                ...
                <form id="pdfForm" action="/post" method="post" class="employee-form">
                 @csrf
              ...
              <div class="form-navigation mt-3">
                 ...
                 <button type="button" class="pdf btn btn-success float-right mr-3" onclick="generatePDF()">Generate PDF Preview</button>
              </div>
...
<script>
    ...
    $(function(){
        ...
        function navigateTo(index){
            ...
            $('.form-navigation .pdf').toggle(atTheEnd);
    ...
    function generatePDF() {
        ...
        // Remove the previous PDF preview iframe if it exists
        var existingIframe = document.getElementById('pdfContainer').querySelector('iframe');
        if (existingIframe) {
            existingIframe.remove();
        }

        // Send an AJAX request to generate the PDF preview
        fetch('/generate-pdf', {
            method: 'POST',
